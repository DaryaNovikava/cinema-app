...
export const ButtonUpdate: React.FC<ButtonUpdateProps> = ({ onClick }) => {
  return (
    <button
      className="btn-reset btn-update"
      onClick={onClick}
    >
      <svg className='btn-update__image' width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
